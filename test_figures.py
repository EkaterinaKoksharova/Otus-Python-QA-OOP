...
from base_figure import Triangle
from base_figure import Rectangle
from base_figure import Square
from base_figure import Circle
...
class TestFigures:
    ...
    def test_circle_angles(self):
        """ Проверка количества уголв круга"""
